...
import com.hathme.android.databinding.ActivityBucketCouponListBinding;
...
public class BucketCouponListActivity extends BaseActivity implements View.OnClickListener {
    ActivityBucketCouponListBinding b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setContentView(R.layout.activity_bucket_coupon_list);
        b = ActivityBucketCouponListBinding.inflate(getLayoutInflater());
    ...
    private void hitGetCouponListApi() {
        ...
        WebServices.getApi(mActivity, AppUrls.getBucketCoupon, false, true, new WebServicesCallback() {
    ...
    private void hitApplyCouponApi(String id) {
        ...
        WebServices.postApi(mActivity, AppUrls.ApplyBucketCoupon, json, false, true, new WebServicesCallback() {
