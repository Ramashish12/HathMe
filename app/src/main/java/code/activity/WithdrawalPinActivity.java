...
import com.hathme.android.databinding.ActivityWithdrawalPinBinding;
...
public class WithdrawalPinActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void inits() {
        ...
        b.header.tvHeader.setText(getString(R.string.withdrawalPin));
    ...
    private void hitSendMoney() {
        ...
        WebServices.postApi(mActivity, AppUrls.walletToWalletTransfer, json, true, true, new WebServicesCallback() {
