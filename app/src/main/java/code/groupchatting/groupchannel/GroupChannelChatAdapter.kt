...
import com.hathme.android.databinding.ListItemChatAdminBinding
import com.hathme.android.databinding.ListItemChatImageReceiveBinding
import com.hathme.android.databinding.ListItemChatImageSendBinding
import com.hathme.android.databinding.ListItemChatReceiveBinding
import com.hathme.android.databinding.ListItemChatSendBinding
...
import code.chat.OpenChannelChatAdapter
...
class GroupChannelChatAdapter(
    ...
    inner class GroupChatSendViewHolder(private val binding: ListItemChatSendBinding) :
        ...
        fun bind(
            ...
            if (message.sendingStatus == SendingStatus.SUCCEEDED) {
                ...
                if (showDate) {
                    binding.dateTagView.text=convertLongToDate(message.createdAt)
    ...
    inner class GroupChatImageSendViewHolder(private val binding: ListItemChatImageSendBinding) :
        ...
        fun bind(
            ...
            if (message.sendingStatus == SendingStatus.SUCCEEDED)
            {
                if (message.thumbnails.equals(""))
                {
                    binding.chatBubbleImageSend.visibility = View.GONE
                }
                else
                {
                    binding.chatBubbleImageSend.visibility = View.VISIBLE
                ...
                if (showDate) {
                    binding.dateTagView.text=convertLongToDate(message.createdAt)
                    binding.dateTagView.visibility = View.VISIBLE
                } else { binding.dateTagView.visibility = View.GONE
                }
                if (showTime) {
                    binding.textviewTime.text = message.createdAt.toTime()
                    binding.textviewTime.visibility = View.VISIBLE
...
//            if (message.thumbnails.equals(""))
//            {
//                binding.chatBubbleImageReceive.visibility = View.GONE
//                binding.chatBubbleImageReceive.setImageUrl(message.url, message.plainUrl)
//            }
//            else
//            {
//                binding.chatBubbleImageReceive.visibility = View.VISIBLE
//                binding.chatBubbleImageReceive.setImageUrl(message.thumbnails.toString(), message.plainUrl)
//            }
            binding.chatBubbleImageReceive.visibility = View.VISIBLE
            binding.chatBubbleImageReceive.setImageUrl(message.url, message.plainUrl)
            if (showName) {
