package code.groupvideocall.preview
...
import code.groupvideocall.util.*
import com.hathme.android.R
import com.hathme.android.databinding.ActivityVideoPreviewBinding

class VideoPreviewActivity : BaseActivity() {
    private val viewModel: VideoPreviewViewModel = VideoPreviewViewModel()
    ...
    private fun goToRoomActivity() {
        val roomId = intent.getStringExtra(EXTRA_ROOM_ID) ?: throw IllegalStateException("Room ID must not be null")
        val intent = Intent(this, VideoRoomActivity::class.java).apply {
