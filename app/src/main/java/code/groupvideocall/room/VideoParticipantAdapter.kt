...
import com.hathme.android.databinding.ItemParticipantBinding
...
class VideoParticipantAdapter(
    participants: List<Participant>
) : RecyclerView.Adapter<VideoParticipantAdapter.ParticipantViewHolder>() {
    ...
    class ParticipantViewHolder(
        ...
        fun bind(participant: Participant) {
            ...
            val userName = AppSettings.getString(AppSettings.name)

            binding.participantTextViewUserName.text = userName
