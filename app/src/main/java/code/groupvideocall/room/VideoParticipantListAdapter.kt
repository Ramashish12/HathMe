...
import com.hathme.android.databinding.ItemParticipantListShareRoomIdBinding
import com.hathme.android.databinding.ItemParticipantListUserBinding
import com.sendbird.calls.Participant

class VideoParticipantListAdapter(
    val roomId: String
) : RecyclerView.Adapter<VideoParticipantListAdapter.BaseViewHolder>() {
